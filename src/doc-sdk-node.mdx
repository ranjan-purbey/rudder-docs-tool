...
<a
  href="https://www.npmjs.com/package/@rudderstack/rudder-sdk-node"
  target="_blank"
  align="left"
>
  <img
    src="https://img.shields.io/npm/v/@rudderstack/rudder-sdk-node.svg?style=flat"
    alt="Github Badge"
    class="githubBadge"
  />
</a>
...
- Once signed up, set up a Node.js source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/). You should then see a **Write Key** for this source, as shown below:

<img
  src="../../assets/event-stream-sources/node-sdk-1.png"
  alt="Node.js source write key"
/>
...
<div class="infoBlock">
  To use this feature, you will need to host a Redis server and use it as the
  intermediary data storage queue.
</div>
